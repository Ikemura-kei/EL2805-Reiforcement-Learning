...
run1 = 'q_i_2_eps=0.1_zeros_q0_2024-12-09 14:31:48' # epsilon=0.1, zeros_init
run2 = 'q_i_2_eps=0.1_rand_q0_2024-12-09 14:33:08' # epsilon=0.1, rand_init
run3 = 'q_i_2_eps=0.1_encourage_q0_2024-12-09 14:36:12' # epsilon=0.1, encourage_move_init
run4 = 'q_i_2_eps=0.2_encourage_q0_2024-12-09 14:34:27' # epsilon=0.2, encourage_move_init
...
plt.plot(win_rates1[:, 0], win_rates1[:, 1], 'r')
plt.plot(win_rates2[:, 0], win_rates2[:, 1], 'g')
plt.plot(win_rates3[:, 0], win_rates3[:, 1], 'b')
plt.plot(win_rates4[:, 0], win_rates4[:, 1], 'y')
